...
urlpatterns = [
    ...
    path(
        "api/admin/reviews/<int:review_id>/",
    ...
    path(
        ...
        AdminAnalyticsSalesView.as_view(),
        name="admin-analytics-sales",
    ),
    path(
        "api/admin/analytics/revenue/",
        AdminAnalyticsRevenueView.as_view(),
        name="admin-analytics-revenue",
    ),
    path(
        "api/admin/analytics/customers/",
        AdminAnalyticsCustomersView.as_view(),
        name="admin-analytics-customers",
    ),
    path(
        "api/admin/analytics/products/",
        AdminAnalyticsProductsView.as_view(),
        name="admin-analytics-products",
    ),
    # Admin Payments URLs
    path(
        "api/admin/payments/methods/",
        AdminPaymentMethodsView.as_view(),
        name="admin-payment-methods",
    ),
    path(
        "api/admin/payments/methods/<int:method_id>/",
        AdminPaymentMethodsView.as_view(),
        name="admin-payment-method-detail",
    ),
    path(
        "api/admin/payments/methods/<int:method_id>/toggle/",
        AdminPaymentMethodToggleView.as_view(),
        name="admin-payment-method-toggle",
    ),
    path(
    ...
    path(
        "api/admin/payments/refunds/", AdminRefundsView.as_view(), name="admin-refunds"
    ),
    # Token & Reviews
