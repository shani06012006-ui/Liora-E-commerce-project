...
const Collections = () => {
  ...
  const fetchWishlist = useCallback(async () => {
    ...
    try {
      ...
      const wishlistMap = {}; const wishlistSet = new Set();
      res.data.forEach(item => {
        const productId = item.product_details?.id || item.product;
        wishlistMap[productId] = item.id; wishlistSet.add(productId);
      });
    ...
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 py-10 md:py-16">
          <h1 className="text-3xl md:text-6xl font-light text-gray-900 tracking-wide mb-3">Collections</h1>
          <p className="text-gray-500 text-sm md:text-base max-w-2xl leading-relaxed">
            French know-how with high-quality craftsmanship. Discover elegant pieces that blend timeless style with modern sophistication.
          </p>
          <div className="mt-4">
            <span className="inline-block border-b-2 border-gray-900 pb-1 text-xs md:text-sm font-medium tracking-wide">
              BUY 1 GET 1 15% OFF
            </span>
          </div>
                ...
                <div key={product.id} className="group">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-1.5 mb-2 md:mb-3">
                      <span className="text-gray-900 font-medium text-xs md:text-sm">₹{product.price}</span>
      ...
      <div className="border-t border-gray-200 mt-8 md:mt-12 py-12 md:py-16 bg-white">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <h3 className="text-xl md:text-2xl font-light text-gray-900 mb-3">Subscribe to get 15% off</h3>
